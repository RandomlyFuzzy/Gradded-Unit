...
public class Level2Solo extends ILevel {
    ...
    public void init() {
        ...
        AddObject(new PlatForm(new Vector(75, 0), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        AddObject(new PlatForm(new Vector(-200, -75), 0.35)).GetSprite("/images/Platform/rock_platform_moss_01.png");
        AddObject(new PlatForm(new Vector(-425, -140), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        AddObject(new PlatForm(new Vector(-90, -330), -0.25)).GetSprite("/images/Platform/rock_platform_moss_01.png");
        AddObject(new PlatForm(new Vector(150, -425), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        AddObject(new PlatForm(new Vector(-170, -600), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        AddObject(new PlatForm(new Vector(-400, -600), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        ...
        AddObject(new PlatForm(new Vector(-400, -2000), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        AddObject(new PlatForm(new Vector(-150, -2150), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        AddObject(new PlatForm(new Vector(-350, -2300), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
        AddObject(new PlatForm(new Vector(-200, -2500), 0)).GetSprite("/images/Platform/rock_platform_clean_01.png");
