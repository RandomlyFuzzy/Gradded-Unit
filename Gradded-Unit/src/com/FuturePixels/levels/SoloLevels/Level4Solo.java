...
public class Level4Solo extends ILevel {
    ...
    public void init() {
        ...
        //Adding Platforms
        AddObject(new MovingPlatoform(new Vector(100, 100), 0,new Vector[]{new Vector(0,100),new Vector(200,100)},2)).GetSprite("/images/Platform/rock_platform_clean_01.png");
